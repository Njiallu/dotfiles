...
source $XDG_CONFIG_HOME/shell_config
source $XDG_CONFIG_HOME/shell_exports
source $XDG_CONFIG_HOME/shell_functions
#### zsh specifics
source $XDG_CONFIG_HOME/zsh/syntax/zsh-syntax-highlighting.zsh
